        ...
        <main class="main">
            <div class="container">
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb__item">
                        <a href="" class="breadcrumb__link"><span class="breadcrumb__span">محصول شماره یک</span></a>
                    </li>
                </ul>
                <div class="product">
                    <div class="product__header">
                        ...
                        <div class="product__row">
                                ...
                                <div class="gallery">
                                    <div class="gallery__slideshow">
                                        ...
                                        <div class="gallery__slides">
                                            <div class="gallery__slide">
                                                <img class="gallery__img" :src="slide.img" alt="" v-for="(slide, index) in gallerySlides" :key="index" :style="slideIndex === index ? 'display:block;' : 'display:none;'" @click="showModal(slide.img)" />
                                            </div>
                                        </div>
                                    ...
                                    <div class="gallery__content">
                                        <div class="gallery__items">
                                            <div class="gallery__item" :class="{ 'gallery__item--is-acitve': slideIndex === index }" v-for="(slide, index) in gallerySlides" :key="`item-${index}`">
                            ...
                            <div class="product__left">
                                ...
                                <div class="product__info">
                                    ...
                                    <div class="rating">
                                        <div class="rating__star">
                                            <span class="rating__rate" :data-title="rate.title" v-for="rate in ratings" :key="rate.title" @click="rateWidth = rate.width" @mouseover="handleMouseover" @mouseleave="handleMouseleave"></span>
                                        </div>
                                ...
                                <div>
                                    <button class="btn btn--boxshadow btn--brand" @click="addItem(product)" >افزودن به سبد خرید</button>
                                </div>
                ...
                <SwiperSlider>
                    ...
                    <router-link :to="{ name: 'Product', params: { id: item.id } }" class="swiper-slide" v-for="item in products" :key="item.id">
                        <div class="card">
                ...
                <div class="product-details">
                    <div class="tab">
                        <div class="tab__items">
                            <span class="tab__item tab__item--compare" :class="{ 'tab__item--is-active': activeTab === 'compare' }" @click="activeTab = 'compare'">نقد و برسی</span>
                            <span class="tab__item tab__item--featrues" :class="{ 'tab__item--is-active': activeTab === 'featrues' }" @click="activeTab = 'featrues'">ویژیگی ها</span>
                            <span class="tab__item tab__item--comments" :class="{ 'tab__item--is-active': activeTab === 'comments' }" @click="activeTab = 'comments'">نظرات</span>
                        </div>
...
export default {
    ...
    data() {
        return {
            dateCountDown: moment('2022-01-01 00:00:00'),
            diff: null,
            countDownInterval: null,
            gallerySlides: [{ img: require('../assets/img/slider/1.jpg') }, { img: require('../assets/img/slider/2.jpg') }, { img: require('../assets/img/slider/3.jpg') }, { img: require('../assets/img/slider/4.jpg') }, { img: require('../assets/img/slider/4.jpg') }, { img: require('../assets/img/slider/3.jpg') }, { img: require('../assets/img/slider/3.jpg') }, { img: require('../assets/img/slider/3.jpg') }],
            ratings: [
            ...
            slides: [{ img: require('../assets/img/slideshow/1.png') }, { img: require('../assets/img/slideshow/2.png') }, { img: require('../assets/img/slideshow/3.png') }, { img: require('../assets/img/slideshow/4.png') }],
            activeTab: 'compare',
            product: {},
        };
    },
