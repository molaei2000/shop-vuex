        ...
        <div class="container">
            <div class="page">
                ...
                <div class="page__content">
                    ...
                    <div class="products">
                        <router-link :to="{ name: 'Product', params: { id: item.id } }" v-for="item in products" :key="item.id" class="products__item">
                            <div class="card">
                                ...
                                <div class="card__price">
                                    <span class="card__compare-price">{{ item.price }}</span>
...
export default {
    ...
    created() {
        ...
        this.$store.dispatch('getProducts',{text:'abcdefg'});
    },
};
</script>
