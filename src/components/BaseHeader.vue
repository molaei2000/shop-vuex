                ...
                <div class="navbar__row">
                    ...
                    <div class="navbar__action">
                        <div class="header__basket">
                            ...
                            <span class="header__basket-count">{{items.length}}</span>
                                ...
                                <div class="header__dropdown-content header__dropdown-content--overflow">
                                    <div class="header__basket-item" v-for="item in items" :key="item.id">
                                        ...
                                        <div class="header__basket-details">
                                            ...
                                            <div class="header__basket-price">تومان{{item.price}}</div>
                                            <div class="header__basket-price"> عدد{{item.quantity}}</div>
                                            <button  @click="deleteItem(item)" class="btn btn--boxshadow header__basket-remove">حذف</button>
                                        </div>
                                    </div>
                                    <div v-if="items.length >= 1" class="header__basket-btn">
